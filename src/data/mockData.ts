...
export const initialCarListings: CarListing[] = [
  {
    id: 'phone-post-1',
    title: '🍎 آبل آيفون 15 برو ماكس 256GB تيتانيوم طبيعي (مجمرك رسمي كفالة إيماتيل سنة)',
    category: 'mobile',
    condition: 'new',
    make: 'Apple',
  ...
  {
    id: 'phone-post-2',
    title: '🪐 سامسونج جالاكسي S24 ألترا 512GB رمادي تيتانيوم (مع قلم S-Pen وكفالة معتمدة)',
    category: 'mobile',
    condition: 'new',
    make: 'Samsung',
  ...
  {
    id: 'phone-post-3',
    title: '⚡️ شاومي ريدمي نوت 13 برو بلس 5G سعة 512GB (شاحن توربو 120W داخل الصندوق)',
    category: 'mobile',
    condition: 'new',
    make: 'Xiaomi',
  ...
  {
    id: 'phone-post-4',
    title: '📱 سامسونج جالاكسي A55 5G سعة 256GB جديد بالكرتونة (أزرق جليدي كفالة إيماتيل)',
    category: 'mobile',
    condition: 'new',
    make: 'Samsung',
    model: 'Galaxy A55 5G',
  ...
  {
    id: 'phone-post-5',
    title: '🚀 إنفينيكس هوت 40 برو 256GB رام 16GB (مجمرك رسمي بطارية 5000 mAh شحن سريع)',
    category: 'mobile',
    condition: 'new',
    make: 'Infinix',
    model: 'Hot 40 Pro',
    ...
    type: 'sale',
    city: 'سوريا - حماة',
    image: 'https://images.unsplash.com/photo-1570891836654-d4961a7b6929?auto=format&fit=crop&w=800&q=80',
    phone: '+963999332211',
    featured: false,
    createdAt: new Date().toISOString()
  },
  {
    id: 'phone-post-6',
    title: '🎧 سماعات آبل AirPods Pro 2 الأصلية Type-C مع عزل الضوضاء النشط ANC',
